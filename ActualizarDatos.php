...
<div class="col-lg-9 mt-0 py-0 px-5">
    <form action="<?php echo RUTA_URL ?>Coordinador/ActualizarDatos" method="post" class="px-5">
    <h5 class="mt-3">Actualizar datos del aprendiz</h5>
    ...
    <div class="row">
        ...
        <div class="col-lg-12 tamano">
            <button class="btn btn-primary bg-info">Actualizar datos</button>
        </div>
